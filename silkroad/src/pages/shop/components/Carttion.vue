<template>
    <div class="sku-container"  v-if="modle" @click="zero">
    <van-sku
        v-model="showBase"
        :sku="sku"
        :goods="goods_info"
    ...
    <van-button block type="primary" @click="showBase=true" to="/home"></van-button>
    </van-sku>
    <template solot="sku-messages">
...
export default {
    ...
    onBuyClicked(sku){
        ...
        var this_ = this;
        this.$root.eventBus.$on("change",function(msg){
            this_.modle = msg
        })
    }
